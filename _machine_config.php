...
GlobalConfig::$CONNECTION_SETTING->DBName = "assjurprocessos";
...
/** the root url of the application with trailing slash, for example http://localhost/gerenciamentos de processos/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'assjurprocessos/';
