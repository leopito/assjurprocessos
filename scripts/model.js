/**
 * backbone model definitions for Gerenciamentos de Processos
 */
...
/**
 * Processo Backbone Model
 */
model.ProcessoModel = Backbone.Model.extend({
	urlRoot: 'api/processo',
	idAttribute: 'id',
	id: '',
	dataEntrada: '',
	numero: '',
...
/**
 * Processo Backbone Collection
 */
model.ProcessoCollection = model.AbstractCollection.extend({
	url: 'api/processos',
	model: model.ProcessoModel
});
...
/**
 * Setor Backbone Model
 */
model.SetorModel = Backbone.Model.extend({
	urlRoot: 'api/setor',
	idAttribute: 'id',
	id: '',
	nome: '',
...
/**
 * Setor Backbone Collection
 */
model.SetorCollection = model.AbstractCollection.extend({
	url: 'api/setores',
	model: model.SetorModel
});
