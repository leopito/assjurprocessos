...
require_once("DAO/ProcessoCriteriaDAO.php");

/**
 * The ProcessoCriteria class extends ProcessoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProcessoCriteria extends ProcessoCriteriaDAO
{
