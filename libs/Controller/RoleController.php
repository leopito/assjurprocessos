...
class RoleController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Role,Created,Modified'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$role->Role = $this->SafeGetVal($json, 'role');
			$role->Created = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'created')));
			$role->Modified = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'modified')));
	...
	public function Update()
	{
		try
		{
			...
			$role->Role = $this->SafeGetVal($json, 'role', $role->Role);
			$role->Created = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'created', $role->Created)));
			$role->Modified = date('Y-m-d H:i:s',strtotime($this->SafeGetVal($json, 'modified', $role->Modified)));
